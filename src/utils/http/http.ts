...
export class Http {
  static httpClient = IS_DEVELOPMENT ? 'http://127.0.0.1:8888' : 'https://cryptopayserver.online'

  static httpPath = IS_DEVELOPMENT
    ? 'http://127.0.0.1:8888/api'
    : 'https://cryptopayserver.online/api'
  ...
  static delete_email_rule_setting_by_id =
    this.httpPath + '/setting/delete_email_rule_setting_by_id'

  // payment setting
  static find_payment_setting_by_chain_id =
    this.httpPath + '/setting/find_payment_setting_by_chain_id'
  ...
  static find_wallet_address_by_chain_and_network =
    this.httpPath + '/wallet/find_wallet_address_by_chain_and_network'
  ...
  static find_private_key_by_chain_and_network =
    this.httpPath + '/wallet/find_private_key_by_chain_and_network'
  ...
  static send_lightning_network_transaction =
    this.httpPath + '/lightningnetwork/send_lightning_network_transaction'
  ...
  static update_invoice_order_status_by_order_id =
    this.httpPath + '/invoice/update_invoice_order_status_by_order_id'
  ...
  static update_payment_request_by_id =
    this.httpPath + '/paymentrequest/update_payment_request_by_id'
  ...
  // schedule
  static schedule_blockscan = this.httpPath + '/schedule/schedule_blockscan'
  static schedule_invoice_expired = this.httpPath + '/schedule/schedule_invoice_expired'
  static schedule_pull_payment_expired = this.httpPath + '/schedule/schedule_pull_payment_expired'
  static schedule_payment_request_expired =
    this.httpPath + '/schedule/schedule_payment_request_expired'
}
