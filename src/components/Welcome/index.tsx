    ...
    >
      ...
      <section className="mx-auto grid max-w-6xl gap-12 px-6 pb-20 pt-16 lg:grid-cols-[1.1fr_1fr] lg:items-center lg:pb-28 lg:pt-24">
        <div>
          ...
          <h1 className="font-[family-name:var(--font-mono)] text-4xl font-bold leading-[1.1] tracking-tight sm:text-5xl">
      ...
      <section id="features" className="mx-auto max-w-6xl px-6 py-20">
        <div className="mb-10 flex items-end justify-between">
          <div>
            <p className="font-[family-name:var(--font-mono)] text-xs uppercase tracking-widest text-[#E8A33D]">
        ...
        <div className="divide-y divide-white/[0.06] border-y border-white/[0.06]">
          {FEATURES.map((f) => (
            ...
            >
              <span className="pt-0.5 font-[family-name:var(--font-mono)] text-sm text-white/25">
                {f.n}
              </span>
      ...
      <section className="border-y border-white/[0.06] py-10">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-6 px-6">
          ...
          <div className="flex flex-wrap items-center gap-x-8 gap-y-3 font-[family-name:var(--font-mono)] text-sm text-white/50">
            <span>Next.js</span>
            <span>React</span>
            <span>MySQL</span>
            <span>Prisma</span>
      ...
      <section className="mx-auto max-w-6xl px-6 py-24 text-center">
        ...
        <p className="mx-auto mt-3 max-w-md text-sm text-white/50">
          Open{' '}
          <code className="rounded bg-white/5 px-1.5 py-0.5 font-[family-name:var(--font-mono)]">
            :5230
          </code>{' '}
          and start accepting payments today.
        </p>
