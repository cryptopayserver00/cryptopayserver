...
//   const getLitecoinWalletAddress = async () => {
//     try {
...
//   const getLitecoinPaymentSetting = async () => {
//     try {
...
//     await getLitecoinWalletAddress();
...
//   const init = async () => {
//     await getLitecoinWalletAddress();
//     await getLitecoinPaymentSetting();
...
//                 variant={'contained'}
//                 onClick={() => {
//                   window.location.href = '/wallets/litecoin/send';
//                 }}
//               >
//                 Send
//               </Button>
