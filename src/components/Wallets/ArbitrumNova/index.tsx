...
//             <Image src={ArbitrumNovaSVG} alt="" width={50} height={50} />
//             <h1 className="text-xl font-bold pl-2">Arbitrum Nova Wallet</h1>
//           </div>
...
//         {/* Gas Tracker */}
//         <div className="mt-8">
//           <h2 className="text-xl font-bold">Arbitrum Nova Gas Tracker</h2>
...
//                       <div>
//                         <p className="font-bold text-lg">Arbitrum Nova</p>
//                         <div className="mt-2">
//                           <button
...
//                         </a>
//                         <a
//                           href={GetBlockchainAddressUrl(item.address)}
//                           target="_blank"
//                           rel="noreferrer"
//                           className="px-4 py-2 border border-blue-600 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950/30 rounded-md font-medium text-sm transition-colors inline-block"
//                         >
