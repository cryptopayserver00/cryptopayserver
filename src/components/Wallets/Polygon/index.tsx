...
// import { GetBlockchainAddressUrl, GetBlockchainTxUrl } from '@/utils/chain/pol';
...
//   const getPolygonWalletAddress = async () => {
//     try {
...
//   const getPolygonPaymentSetting = async () => {
//     try {
...
//   const init = async () => {
//     await getPolygonWalletAddress();
//     await getPolygonPaymentSetting();
//     await getPolygonFeeRate();
//   };
...
//             <Image src={PolygonSVG} alt="" width={50} height={50} />
...
//                 variant={'contained'}
//                 onClick={() => {
//                   window.location.href = `/wallets/send?chainId=${CHAINS.POLYGON}`;
//                 }}
//               >
//                 Send
//               </Button>
...
//         <Box mt={8}>
//           <Typography variant="h6">Polygoin Gas Tracker</Typography>
