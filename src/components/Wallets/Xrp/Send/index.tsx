...
import { AddressBookRowType, CoinBalanceType, XrpTrustLineType } from '@/utils/types'
...
const XrpSend = () => {
  ...
  const [trustLines, setTrustLines] = useState<XrpTrustLineType[]>([])
  ...
  return (
    <div className="mb-16 flex flex-col items-center">
      <div className="my-8 flex items-center justify-center gap-2">
        <Image
          src={GetImgSrcByChain(CHAINS.XRP)}
          alt="chain"
          width={50}
          height={50}
          className="h-12 w-12"
