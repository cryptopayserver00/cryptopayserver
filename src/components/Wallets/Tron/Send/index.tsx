...
import { AddressBookRowType, CoinBalanceType, TronResourceType } from '@/utils/types'
...
const TronSend = () => {
  ...
  const [resourceType, setResourceType] = useState<TronResourceType>()
  ...
  return (
    <div className="mb-16 flex flex-col items-center">
      <div className="my-8 flex items-center justify-center gap-2">
        <Image
          src={GetImgSrcByChain(CHAINS.TRON)}
          alt="chain"
          width={50}
          height={50}
          className="h-12 w-12"
