...
// import { GetBlockchainAddressUrl, GetBlockchainTxUrl } from '@/utils/chain/base';
...
//   const getBasePaymentSetting = async () => {
//     try {
...
//   const init = async () => {
//     await getBaseWalletAddress();
//     await getBasePaymentSetting();
//     await getBaseFeeRate();
//   };
...
//                 variant={'contained'}
//                 onClick={() => {
//                   window.location.href = `/wallets/send?chainId=${CHAINS.BASE}`;
//                 }}
//               >
//                 Send
//               </Button>
...
//         <Box mt={8}>
//           <Typography variant="h6">Base Gas Tracker</Typography>
